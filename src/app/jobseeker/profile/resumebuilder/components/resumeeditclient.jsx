      ...
      <form onSubmit={handleFormSubmit} className="space-y-6">
        ...
        <div className="space-y-6">
            ...
            <div key={idx} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-2">
                <input
                  ...
                  className="w-full sm:w-1/2 p-3 border rounded-xl mt-1 shadow-sm"
                />
                <input
                  type="month"
                  name="toDate"
          ...
          <button
            ...
            className="bg-blue-500 text-white px-6 py-2 rounded-lg mt-6 w-full sm:w-auto hover:bg-blue-600 transition"
          >
            Add Work Experience
          </button>
        </div>
